...
class BasicPointerInfo extends PointerInfoBase {
    ...
    upPosition;
    event;
    constructor(entered = false, pressed = false, downPosition = new DOMPoint(), upPosition = new DOMPoint, event = null) {
        super();
     ...
     */
    get button() {
        return (this.event instanceof MouseEvent ? this.event.button :
...
function hasBasicPointerCallback(params) {
 ...
 * reloading the page.
 */
function handleBasicPointer(element, params) {
    const state = {
        touchStarted: false,
        touchTimestamp: -1,
    };
